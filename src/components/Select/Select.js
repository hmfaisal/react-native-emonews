...
import { colorGold, colorGoldInverse } from "../../assets/base";
    ...
    return (
      <View style={this.props.style}>
        ...
        <Button
          ...
          buttonStyle={{ backgroundColor: colorGold}}
          icon={{ name: this.props.icon, color:colorGoldInverse, type:"ionicon", size:24 }}
          titleStyle={{
            color:colorGoldInverse,
          }}
        />
        <SelectModal
          ref={instance => {
